...
def do_download_video():
    ...
    for idx in selected:
        ...
        try:
            ...
            parser.download_file(video_url, video_file + ".video.tmp", video_progress, "video", ep_bvid)
            print()
            ...
            if audio_url:
                ...
                parser.download_file(audio_url, video_file + ".audio.tmp", audio_progress, "audio", ep_bvid)
                print()
...
def _download_by_url(url):
    ...
    try:
        ...
        parser.download_file(video_url, video_file + ".video.tmp", vp, "video", bvid)
        print()
        ...
        if audio_url:
            ...
            parser.download_file(audio_url, video_file + ".audio.tmp", ap, "audio", bvid)
            print()
